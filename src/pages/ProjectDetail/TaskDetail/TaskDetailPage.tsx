...
function getAttentionRunId(attention: Task['attention']): string | null { if (!attention) return null; const record = attention as unknown as { taskRunId?: unknown }; return typeof record.taskRunId === 'string' && record.taskRunId.trim() ? record.taskRunId : null }
