...
const agent = { id: 'agent', name: 'Agent', avatar: null, role: 'DEVELOPER' as const, capabilities: [], visibility: 'PRIVATE' as const, status: 'ACTIVE' as const, createdBy: 'user', description: null, skillAccessScope: 'PROJECT' as const, memoryAccessScope: 'PROJECT' as const, runtime: { status: 'IDLE' as const, activeRunCount: 0, concurrencyLimit: null, assignmentUsage: { requirementGroups: { assignedCount: 0, assignableCount: 0 }, workflows: { assignedCount: 0, assignableCount: 0 } } } }
